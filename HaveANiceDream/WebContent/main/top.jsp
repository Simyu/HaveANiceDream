...
<body>
	...
	<header class="header black-bg">
		...
		<!--logo start-->
		<a href="index.html" class="logo"><b>HAVE A NICE DAY</b></a>
		<!--logo end-->
				...
				<li id="header_inbox_bar" class="dropdown"><a
					...
					<ul class="dropdown-menu extended inbox">
						...
						<li><a href="index.html#"> <span class="photo"><img
									alt="avatar" src="../Theme/assets/img/ui-zac.jpg"></span> <span
						...
						<li><a href="index.html#"> <span class="photo"><img
									alt="avatar" src="../Theme/assets/img/ui-divya.jpg"></span> <span
						...
						<li><a href="index.html#"> <span class="photo"><img
									alt="avatar" src="../Theme/assets/img/ui-danro.jpg"></span> <span
								class="subject"> <span class="from">Dan Rogers</span> <span
									class="time">2 hrs.</span>
							</span> <span class="message"> Love your new Dashboard. </span>
						</a></li>
						<li><a href="index.html#"> <span class="photo"><img
									alt="avatar" src="../Theme/assets/img/ui-sherman.jpg"></span> <span
