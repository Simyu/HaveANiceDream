...
<body>
		<div>
			<div class="col-sm-12" style="color: black; padding-top: 35px;"><h3>평가하기</h3></div>
			<div class="steps pn no-mg-no-pd" style="margin-top: 100px; background-color: #393d40; height: auto; ">
				...
				<div class="col-sm-1 no-mg-no-pd" style="height: 50px; margin-top: 30px;"></div>
				<div class="col-sm-10 no-mg-no-pd" style="height: 50px; margin-top: 30px; "> <input type="text" class="form-control"></div>
				<div class="col-sm-1 no-mg-no-pd" style="height: 50px; margin-top: 30px;"></div>
