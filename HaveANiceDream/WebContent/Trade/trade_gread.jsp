		...
		<div class="col-md-10 col-sm-10 col-xs-10">
			...
			<form role="form" class="form-horizontal"
				...
				<div class="col-md-12 col-sm-12 col-xs-12 steps pn no-mg-no-pd" style="background-color: #d5e1ed; height: auto;">
					...
					<input id='op1' name="group" type='checkbox' value="매우만족" checked/> <label for='op1'>매우만족</label> 
					</div>
					<div class="col-md-2 col-sm-2 col-xs-2 no-mg-no-pd" >
					<input id='op2'name="group" type='checkbox' value="만족"/> <label for='op2'>만족</label> 
					</div>
					<div class="col-md-2 col-sm-2 col-xs-2 no-mg-no-pd" >
					<input id='op3' name="group" type='checkbox' value="보통"/> <label for='op3'>보통</label>
					</div>
					<div class="col-md-2 col-sm-2 col-xs-2 no-mg-no-pd" >
					<input id='op4'name="group" type='checkbox' value="불만족" /> <label for='op4'>불만족</label>
					</div>
					<div class="col-md-3 col-sm-3 col-xs-3 no-mg-no-pd" >
					<input id='op5'name="group" type='checkbox' value="매우불만족"/> <label for='op5'>매우불만족</label>
					</div>
					...
					<div class="col-md-6 col-sm-6 col-xs-6 no-mg-no-pd">
					<input type='submit' value='평가하기' id='submit' onclick="javascript:insertPath
