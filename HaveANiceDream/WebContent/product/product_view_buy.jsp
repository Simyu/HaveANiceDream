				...
				<form class="form-horizontal style-form" method="get"
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							...
							<span class="help-block">A block of help text that breaks
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" disabled="disabled">
							<label>반드시 실명을 작성해 주시기 바랍니다.</label>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input class="form-control" type="text"
								value="This is focused..." disabled="disabled">
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 col-sm-2 control-label">상세설명</label>
						<div class="col-sm-10">
							<textarea rows="10" cols="100%" disabled="disabled"></textarea>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<div class="col-sm-6">
							...
							<div class="col-sm-4">
								<p class="form-control-static">로그인된상태이니까 아이디를 통해 가져옵니다.</p>
							</div>
