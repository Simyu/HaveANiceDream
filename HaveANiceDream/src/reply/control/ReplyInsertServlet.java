...
public class ReplyInsertServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if(ses!=null){
			...
			ReplyDTO replywrite = new ReplyDTO(null, Integer.parseInt(boardNo), replyContent, userId, null);
	...
	//		String url = "../board/board_list_Read.jsp";
			
	//		viewpath = "/HaveANiceDream/board/read.do?url="+url+"&boardNo="+boardNo;
